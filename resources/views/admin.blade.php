...
<head>
  ...
  @vite('resources/js/app.js')
    ...
    <!-- modernizr js -->
    <script type="text/javascript" src="admin/admin/assets/js/modernizr/modernizr.js "></script>
    <!-- slimscroll js -->
    <script type="text/javascript" src="admin/admin/assets/js/SmoothScroll.js"></script>
    ...
    <!-- custom js -->
    <script type="admin/text/javascript" src="assets/pages/dashboard/custom-dashboard.js"></script>
    <script type="admin/text/javascript" src="assets/js/script.js "></script>
</body>
